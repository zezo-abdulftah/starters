        ...
        <ul id="myUL" style="text-align : right;"  >
           <?php
            ...
            while ($row=  mysqli_fetch_array($select)){
                ...
                echo '  <li><a href="productArabic.php?id='.$row["id"].'"><i class="fas fa-laptop-code"></i>'.$row["itemname"].'</a></li>';
            }
            ?>
        </ul>
         <div class="Lang">
             <a style="color:white" href="#" >عربي</a>
            <a style="color:white" href="index.php" >English</a>
        </div>
    </div>
       ...
       <!-- Headr contain nav bar -->
        <nav class="navbar navbar-expand-lg header "  >
              ...
              <div class="collapse navbar-collapse justify-content-end " id="Navbar" >
                   <ul class="nav col-lg-12 col-1 "  >
                      ...
                      <li class="nav-item">
                        <a class="nav-link" href="#">الأساسية</a>
                    ...
                    <div class="carousel-inner">
                        <div class="carousel-item active">
                         ...
                         while ($row1 = mysqli_fetch_array($sell)) {
                           ...
                           .'<span style="width:190px;height:23px;" class="badge badge-secondary">السعر قبل العرض='.$row1["price"].'</span> <br>'
                                        .'<span style="width:190px;height:23px;" class="badge badge-secondary">السعر بعد العرض='.$row1["result"].'</span><br>'
                             .'</div>'
                                 .'</div>';
                         }
        ...
        <!-- multi brand slider-->
            <div class="row" style="padding:15px;">
                <br>
                  <h3 class=" col-12 " style="text-align:right; " >اسم الصنف</h3>
                <br>
